...
public class Constants {
    ...
    public static final class SlideConstants {
        ...
        static public double meters2ticks(double height) {
            return (height/ SlideConstants.distance_per_tick);
        }
        static public double ticks2meters(double ticks) {
            return (ticks* SlideConstants.distance_per_tick);
        }
    }
    ...
    public static final class JointConstants{
        ...
        public static final double groundPosOpenSlide = 0.5;
        public static final double deg90Pos = 1;
